 ...
 * – Blue header design with Madhura branding (#4A637D)
...
let LOGO_B64 = "";
const LOGO_PATHS = [
  path.resolve(__dirname, "../../frontend/src/images/Madhura-logo.png"),
  path.resolve(__dirname, "../../frontend/public/favicon.ico.png"),
  path.resolve(__dirname, "../../frontend/src/images/madhura_sig_stamp.png"),
];
...
<div class="addr-strip avoid">
  ...
  <div class="doc-details-box">
    <div class="doc-box-header">Invoice Details</div>
    <div class="doc-box-content">
      ...
      <div class="doc-row"><strong>Valid Until:</strong> <span>${h.validity || "07-07-2026"}</span></div>
      <div class="doc-row"><strong>State Code:</strong> <span>33</span></div>
      <div class="doc-row doc-divider"><strong>Customer ID:</strong> <span>${h.client_code || `MT${String(h.customer_id || h.client_id || docId).padStart(3, "0")}`}</span></div>
