      ...
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' }}>
        <View style={{ backgroundColor: '#fff', borderRadius: 24, padding: 24, paddingBottom: 40 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }}>
            <Text style={{ fontSize: 16, fontWeight: '500', color: '#0f172a' }}>Email Report</Text>
          ...
          {report && (
            <View style={{ backgroundColor: '#eff6ff', borderRadius: 12, padding: 12, marginBottom: 16 }}>
              <Text style={{ fontSize: 12, fontWeight: '500', color: '#0284c7' }}>{report.title}</Text>
          ...
          <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6 }}>Recipient Email *</Text>
          <TextInput
            value={clientEmail}
          ...
          <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6 }}>Recipient Name</Text>
          <TextInput
            value={clientName}
          ...
          <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6 }}>Custom Message (optional)</Text>
          <TextInput
            value={message}
          ...
          >
            ...
            <Text style={{ color: '#fff', fontWeight: '500', fontSize: 14 }}>{sending ? 'Sending...' : 'Send Excel Report'}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
    ...
    <AppLayout currentScreen="Reports" role={role} scrollable={false}>
      <View style={{ flex: 1 }}>
        <View style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: '500', color: '#0f172a' }}>Activity Reports</Text>
        </View>
            ...
            <View style={{ backgroundColor: '#fff', borderRadius: 24, borderWidth: 1, borderColor: '#e2e8f0', padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3 }}>
              ...
              <View style={{ backgroundColor: '#f8fafc', borderRadius: 16, padding: 16, marginBottom: 24, borderLeftWidth: 4, borderLeftColor: '#0284c7' }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Text style={{ fontSize: 13, fontWeight: '500', color: '#0f172a', marginBottom: 6 }}>
                  ...
                  {editingReportId && (
                    <TouchableOpacity onPress={() => {
                      ...
                      <Text style={{ fontSize: 11, color: '#ef4444', fontWeight: '500' }}>Cancel Edit</Text>
                    </TouchableOpacity>
                  )}
                </View>
              ...
              <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8, marginTop: 12 }}>Report Frequency *</Text>
              <View style={{ flexDirection: 'row', backgroundColor: '#f1f5f9', borderRadius: 16, padding: 4, marginBottom: 20 }}>
                {['Weekly', 'Monthly', 'Closure'].map((t) => (
                  ...
                  >
                    <Text style={{ fontSize: 12, fontWeight: '500', color: type === t ? '#fff' : '#64748b' }}>{t}</Text>
                  </TouchableOpacity>
                ))}
              </View>
              ...
              <View style={{ flexDirection: 'row', gap: 16, marginBottom: 20 }}>
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 }}>Start Date *</Text>
                  <CrossPlatformDatePicker value={startDate} onChange={setStartDate} />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 }}>End Date *</Text>
                  <CrossPlatformDatePicker value={endDate} onChange={setEndDate} />
                </View>
              </View>
              
              <Text style={{ fontSize: 13, fontWeight: '500', color: '#0f172a', marginBottom: 12, marginTop: 8 }}>Additional Manual Details (Optional)</Text>
              
              <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 8 }}>Select Client</Text>
              {clients.length === 0 ? (
                ...
                <View style={{ borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 14, overflow: 'hidden', marginBottom: 20 }}>
                  <ScrollView style={{ maxHeight: 200 }} nestedScrollEnabled>
                    ...
                    >
                      <Text style={{ fontSize: 14, fontWeight: '500', color: !selectedClient ? '#0284c7' : '#0f172a' }}>General Report (No Client)</Text>
              ...
              <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6, marginTop: 4 }}>Executive Summary</Text>
              <TextInput
                value={manualSummary}
              ...
              <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6 }}>Next Steps</Text>
              <TextInput
              ...
              <Text style={{ fontSize: 11, fontWeight: '500', color: '#64748b', textTransform: 'uppercase', marginBottom: 6 }}>Quotations / Pricing</Text>
              <TextInput
                value={manualQuotes}
              ...
              <View style={{ backgroundColor: '#f0fdf4', borderRadius: 16, padding: 16, marginBottom: 24, borderWidth: 1, borderColor: '#bbf7d0' }}>
                <Text style={{ fontSize: 12, fontWeight: '500', color: '#16a34a', marginBottom: 8 }}>Included Data Points:</Text>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                  {['Client Meetings', 'Follow-ups', 'Task Progress', 'Executive Stats', 'Manual Details'].map(item => (
                    <View key={item} style={{ backgroundColor: '#dcfce7', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 }}>
                      <Text style={{ fontSize: 10, fontWeight: '500', color: '#15803d' }}>✓ {item}</Text>
                    </View>
                  ))}
                </View>
              </View>
              ...
              <TouchableOpacity onPress={() => setShowAddForm(false)} style={{ marginTop: 12, paddingVertical: 14, borderRadius: 14, borderWidth: 1.5, borderColor: '#e2e8f0', alignItems: 'center' }}>
                <Text style={{ color: '#64748b', fontWeight: '500', fontSize: 13 }}>Cancel</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        ) : (
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              ...
              <TouchableOpacity onPress={() => {
                ...
                <Text style={{ color: '#fff', fontWeight: '500', fontSize: 12 }}>Generate</Text>
              </TouchableOpacity>
            </View>
            ...
            <FlatList
              ...
              ListEmptyComponent={() => (
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: 60, gap: 12 }}>
                  ...
                  <Text style={{ fontSize: 14, color: '#64748b', fontWeight: '400' }}>No reports yet</Text>
                  ...
                  <View style={{ marginBottom: 14, backgroundColor: '#fff', borderRadius: 20, borderWidth: 1, borderColor: '#e2e8f0', shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 6, elevation: 2, overflow: 'hidden' }}>
                    <TouchableOpacity activeOpacity={0.8} onPress={() => setExpandedReportId(isExpanded ? null : item._id)} style={{ padding: 16 }}>
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 }}>
                        <Text style={{ fontWeight: '500', fontSize: 14, color: '#0f172a', flex: 1, marginRight: 8 }}>{item.title}</Text>
                        <View style={{ backgroundColor: '#eff6ff', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 }}>
                          <Text style={{ fontSize: 10, fontWeight: '500', color: '#0284c7', textTransform: 'uppercase' }}>{item.type}</Text>
                        </View>
                      </View>
                      ...
                      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 10 }}>
                        {[
                          ...
                          <View key={stat.label} style={{ backgroundColor: '#f8fafc', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6, borderWidth: 1, borderColor: '#e2e8f0' }}>
                            <Text style={{ fontSize: 11, color: '#475569', fontWeight: '400' }}>{stat.icon} {stat.label}: <Text style={{ fontWeight: '500', color: '#0284c7' }}>{stat.val}</Text></Text>
                          </View>
                        ))}
                      </View>

                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', paddingTop: 10, borderTopWidth: 1, borderTopColor: '#f1f5f9', gap: 10 }}>
                        <Text style={{ fontSize: 10, color: '#94a3b8', minWidth: 60 }}>By: {item.generatedBy?.name || 'System'}</Text>

                        <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 6, flex: 1, justifyContent: 'flex-end' }}>
                          {/* Download Excel */}
                          <TouchableOpacity
                          ...
                          >
                            ...
                            <Text style={{ fontSize: 11, fontWeight: '500', color: '#16a34a' }}>Excel</Text>
                          </TouchableOpacity>
                          ...
                          {['Admin', 'Project Manager', 'Team Lead', 'Managing Director MD'].includes(role) && (
                            ...
                            >
                              ...
                              <Text style={{ fontSize: 11, fontWeight: '500', color: '#0284c7' }}>Send</Text>
                            </TouchableOpacity>
                          )}
                          ...
                          {['Admin', 'Project Manager', 'Team Lead', 'Managing Director MD'].includes(role) && (
                            ...
                            >
                              ...
                              <Text style={{ fontSize: 11, fontWeight: '500', color: '#d97706' }}>Edit</Text>
                            </TouchableOpacity>
                          )}
                          ...
                          {['Admin', 'Project Manager', 'Team Lead', 'Managing Director MD'].includes(role) && item.generatedBy?._id && (
                            ...
                            >
                              ...
                              <Text style={{ fontSize: 11, fontWeight: '500', color: '#ef4444' }}>Issue</Text>
                            </TouchableOpacity>
                          )}
                    ...
                    {isExpanded && (
                      <View style={{ backgroundColor: '#f8fafc', paddingHorizontal: 16, paddingVertical: 14, borderTopWidth: 1, borderTopColor: '#e2e8f0' }}>
                        <Text style={{ fontSize: 11, fontWeight: '500', color: '#475569', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 12 }}>Activity Details</Text>
                          ...
                          item.activities.map((act, i) => (
                            <View key={i} style={{ marginBottom: 12, paddingBottom: 12, borderBottomWidth: i < item.activities.length - 1 ? 1 : 0, borderBottomColor: '#e2e8f0' }}>
                              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 }}>
                                <Text style={{ fontWeight: '500', fontSize: 12, color: '#0f172a', flex: 1 }}>
                              ...
                              <Text style={{ fontSize: 11, color: '#475569', marginBottom: 2 }}>
                                <Text style={{ fontWeight: '400' }}>Exec:</Text> {act.executiveName} · <Text style={{ fontWeight: '400' }}>Co.:</Text> {act.companyName}
                              </Text>
