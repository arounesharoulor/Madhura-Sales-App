...
const Invoice = ({ performaInvoiceId, quotationId }) => {
  ...
  const Band = ({children, style={}}) => (
    <div style={{background:DB,color:"#fff",padding:"7px 14px",fontSize:"8pt",
  ...
  return (
    ...
    <div style={{fontFamily:F,width:"794px",height:"1123px",boxSizing:"border-box",
      padding:"18px",background:"#fff",color:"#111",overflow:"hidden",position:"relative"}}>

      {/* ── BORDER FRAME ── */}
      <div style={{width:"100%",height:"100%",border:"2px solid #003366",
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
          ...
          <div style={{color:"#003366",fontSize:"21pt",fontWeight:"900",
            letterSpacing:"3px",textTransform:"uppercase"}}>{config.label}</div>
        </div>

        {/* ② CORPORATE */}
        <div style={{padding:"7px 20px",borderBottom:BD,background:"#FAFBFC",
          ...
          <div style={{flex:"0 0 42%"}}>
            ...
            <div style={{padding:"9px 14px",fontSize:"8pt",lineHeight:"1.85"}}>
              {[["Doc No",<strong key="d">{docNum}</strong>],
                ["Date",fmtD(docDate)],
                ["Valid Until",h.validity_date?fmtD(h.validity_date):"15 Days"],
                ["State Code","33"],
            ...
            <thead>
              <tr style={{background:DB,color:"#fff"}}>
                {["#","HSN","Description","Qty","Rate (₹)","GST","Tax Val","Amount (₹)"].map((lbl,i)=>(
                  <th key={i} style={{padding:"8px 6px",fontSize:"7.5pt",fontWeight:"700",
        ...
        {/* ⑥ AMOUNT IN WORDS */}
        <div style={{padding:"7px 20px",borderBottom:BD,background:"#FAFCFF",flexShrink:0,
        ...
        <div style={{
          ...
          <div style={{width:"38%",display:"flex",flexDirection:"column",
            ...
            <img src={signImage} alt="sign"
              style={{width:"130px",height:"55px",objectFit:"contain",marginBottom:"8px",display:"block"}}/>
            <div style={{width:"80%",borderTop:"1.5px solid #003366",paddingTop:"6px",textAlign:"center"}}>
              <p style={{fontSize:"7.5pt",color:"#003366",fontWeight:"700",
                textTransform:"uppercase",margin:"0",letterSpacing:"0.5px"}}>Authorised Signatory</p>
              <p style={{fontSize:"6.8pt",color:"#666",margin:"3px 0 0"}}>For Madhura Technologies Pvt. Ltd.</p>
            </div>
          </div>
        </div>
